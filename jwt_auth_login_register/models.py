...
class Box(models.Model):
    ...
    top_texture = models.ImageField(upload_to ='uploads/',default = 'uploads/kraft.jpg')
    bottom_texture = models.ImageField(upload_to ='uploads/',default='uploads/kraft.jpg')
    back_texture = models.ImageField(upload_to ='uploads/',default = 'uploads/kraft.jpg')
    right_texture = models.ImageField(upload_to ='uploads/',default = 'uploads/kraft.jpg')
    left_texture = models.ImageField(upload_to ='uploads/',default = 'uploads/kraft.jpg')
